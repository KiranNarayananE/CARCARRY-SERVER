...
export const walletPayment = async (id, trip) => {
  try {
    ...
    let stringTrip=tripId.toString()
    console.log(stringTrip)
    console.log(typeof(tripId))
    console.log(typeof(tripId.toString()))
    ...
    if (tripCost <= wallet) {
      ...
      await UserModel.updateOne(
        ...
        $push: { "wallet.transactions": {transactionID:stringTrip, method: "paid for trip", cash:tripCost} }}
